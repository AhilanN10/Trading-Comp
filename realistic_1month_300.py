...
def analyze_and_plot(values, trades, daily_values, start_capital, month_name):
    ...
    plt.tight_layout()
    output_path = '/Users/ahilannayani/.gemini/antigravity/brain/e1722e60-7bf5-4969-922b-a2f9396acbc6/realistic_1month_300.png'
...
if __name__ == "__main__":
    ...
    if data.empty:
        ...
        # Run realistic backtest with $300
        values, trades, daily_values = run_realistic_backtest(data, start_capital=300)
        
        # Analyze and plot
        analyze_and_plot(values, trades, daily_values, start_capital=300, month_name=month_name)
