...
def fetch_specific_week(symbol, start_date, end_date):
...
def run_realistic_backtest(df, start_capital=100):
    ...
    print(f"Starting Realistic Backtest (Capital: ${start_capital})...")
    ...
    for index, row in df.iterrows():
        ...
        if position == 0 and row['low'] < avg_low:
            ...
            # Calculate shares (use 95% of cash)
...
def analyze_and_plot(values, trades, start_capital):
    ...
    print("\n" + "="*60)
    print("REALISTIC BACKTEST RESULTS (Nov 10-14, 2025)")
    print("="*60)
    ...
    plt.tight_layout()
    output_path = '/Users/ahilannayani/.gemini/antigravity/brain/e1722e60-7bf5-4969-922b-a2f9396acbc6/realistic_backtest_nov10_14.png'
    plt.savefig(output_path, dpi=150, bbox_inches='tight')
    print(f"\nChart saved to: {output_path}")

if __name__ == "__main__":
    # Fetch data for Nov 10-14, 2025
    symbol = 'ARBK'
    start_date = '2025-11-10T00:00:00Z'
    end_date = '2025-11-14T23:59:59Z'
    
    data = fetch_specific_week(symbol, start_date, end_date)
    ...
    if data.empty:
        ...
        # Analyze and plot
        analyze_and_plot(values, trades, start_capital=100)
